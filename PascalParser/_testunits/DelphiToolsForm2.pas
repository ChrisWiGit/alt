...
var
  ...
  ('Geben Sie in dieses Editierfeld das richtige'#13+
   'Kennwort ein , dass benotigt wird um ein neues'#13+
   'zu definieren  zu knnen.',

   'Geben Sie hier das neue Kennwort ein und'#13+
   'besttigen Sie es nocheinmal im unteren'#13+
   'Editierfeld.',

   'Besttigen Sie in diesem Editierfeld das neue'#13+
   'Kennwort , indem Sie es einfach wiederholt'#13+
   'angeben.',

   'Hiermit wird die anderung des Kennwortes'#13+
   'endgultig besttigt.',

   'Damit wird dir Kennworteingabe'#13+
   'abgebrochen.',

   'Mit Loschen wird das Kennwort deaktiviert.'
   );

  MinLenHint : String = 'Die Minimalzeichenlnge betragt %d.';
  NoPassWordHint : String = 'Soll das Password gelscht werden , muss '#13+
                            'das Eingabefeld leer bleiben.';
  ErrorMsg : Array[1..4] of String=
   ('Das Kennwort muss mind. %d Zeichen lang sein.',
    'Die Besttigung stimmt nicht mit dem neuen Kennwort berein.',
    'Achten Sie auf Gross- und Kleinschreibung!',
    'Das neue Kennwort und die Besttigung besitzen ungleich viele Zeichen.'
    );
  InfoMsg : Array[1..2] of String=
  ( 'Das Masterkennwort wurde benutzt und besttigt.',
    'Das Kennwort wurde gelscht.');
